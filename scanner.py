...
from .patterns import cloud     # noqa: F401 — side effect: registers patterns
from .patterns import payment   # noqa: F401
from .patterns import vcs       # noqa: F401
from .patterns import comms     # noqa: F401
from .patterns import database  # noqa: F401
from .patterns import generic   # noqa: F401
from .patterns import ai       # noqa: F401 — side effect: registers AI provider patterns
...
def scan(text: str, types: Optional[List[str]] = None,
         min_confidence: float = 0.5,
         include_context: bool = True) -> List[Finding]:
    """
